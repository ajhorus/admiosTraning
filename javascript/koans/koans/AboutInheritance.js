...
describe("About Crockford's inheritance improvement", function() {
  ...
  it("should set constructor parameters on the base object", function() {
    this.gonzo.age = 27;
    this.gonzo.hobby = 'Be cool'
    expect(this.gonzo.age).toEqual(27);
    expect(this.gonzo.hobby).toEqual('Be cool');
  });

  it("should set constructor parameters on the derived object", function() {
    this.gonzo.trick = 'Eat';
    expect(this.gonzo.trick).toEqual('Eat');
  });
});
